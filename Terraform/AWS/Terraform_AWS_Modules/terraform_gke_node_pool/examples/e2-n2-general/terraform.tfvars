...
# [노드풀] node_locations 생략 시 클러스터의 노드 위치를 사용합니다.
node_pool = {
...
autoscaling = {
  ...
  min_nodes        = 1
  max_nodes        = 10
  location_policy  = "BALANCED" # BALANCED 또는 ANY
}
...
# [머신/디스크] machine_type은 n2-standard-4 등으로 바꿀 수 있습니다.
# 생략된 항목은 COS_CONTAINERD, 일반 VM, 100GB pd-balanced를 사용합니다.
node_config = {
...
network_tags = ["gke-node", "general-node"]
...
# instance_metadata = { node-purpose = "general" }
