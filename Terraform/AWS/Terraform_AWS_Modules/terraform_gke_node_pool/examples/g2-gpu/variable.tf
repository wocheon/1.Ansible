...
variable "node_config" {
  ...
  validation {
    condition     = startswith(var.node_config.machine_type, "g2-")
    error_message = "L4 프로필은 g2-* 머신 타입을 사용해야 합니다."
  }
}
...
variable "gpu" {
  ...
  default = {}
  validation {
    condition     = var.gpu.type == "nvidia-l4"
    error_message = "이 프로필의 GPU type은 nvidia-l4여야 합니다."
  }
}
